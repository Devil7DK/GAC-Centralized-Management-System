<System.ComponentModel.RunInstaller(True)> Partial Class ServiceLayerInstaller
    ...
    Private Sub InitializeComponent()
        ...
        'ServiceInstaller
        '
        Me.ServiceInstaller.Description = "Web Application Layer Service for GACMS"
        Me.ServiceInstaller.DisplayName = "GACMS Database Layer"
        Me.ServiceInstaller.ServiceName = "GACMS Database Layer"
        Me.ServiceInstaller.StartType = System.ServiceProcess.ServiceStartMode.Automatic
        '
        'ServiceLayerInstaller
        '
